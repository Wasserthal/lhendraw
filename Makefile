all: ./generated/filestructure.hxx parsecdxml.cxx lendefs.h xmldata.hxx xmlparse.hxx cxxdata.h enums.hxx definitionlist.h lendefs.h janitor.hxx createsvg.hxx makeinf.hxx makeinf.cxx 
...
sdl: ./generated/filestructure.hxx parsecdxml.cxx lendefs.h xmldata.hxx xmlparse.hxx cxxdata.h enums.hxx definitionlist.h lendefs.h janitor.hxx createsvg.hxx makeinf.hxx sdlgfx.hxx lhendraw.cxx
	g++ -std=c++0x -m64 lhendraw.cxx -o sdl.out -I/usr/include/SDL -L/usr/lib64 -lSDL -lm -Wno-invalid-offsetof -D GFXOUT_SDL
