...
lhendraw_b32: ./generated/structure.hxx ./generated/reflection.hxx lendefs.h xmldata.hxx xmlparse.hxx cdxdata.hxx conv_cambridge_internal.hxx enums.hxx definitionlist.h janitor.hxx draw.hxx sdlgfx.hxx lhendraw.cxx draw_variables.hxx ./generated/pullout_stringfile.hxx ./generated/reflection_headers.hxx edit.hxx sdlctrl.hxx selection.hxx conv_config_internalconfig.hxx resources_init.hxx filedlg.hxx ps.hxx elements.hxx parsecdxml_variables.hxx ellipeq.h analysis.hxx clipboard.hxx memory.hxx menugfx.hxx pivot.hxx quartic.hxx svg.hxx telescopic_list.hxx text_freetype.h undo.hxx glyf.hxx hatch.hxx help.hxx internal_enum.hxx cmdline.hxx conv_internal_cambridge.hxx HQ.h
	g++ -g -O0 -std=c++0x -m32 lhendraw.cxx -o lhendraw -I/usr/include/SDL -I/usr/include/freetype2 -L/usr/lib -L/usr/lib/i386-linux-gnu -lSDL -lm -lfreetype -lX11 -Wno-invalid-offsetof -D GFXOUT_SDL -D BITMODE32 -lrt -Wreturn-type -D NODEBUG -D NOCLIPBOARD
...
./generated/pullout_stringfile.hxx: ./tools/option tools/pullout.c *.pullout.hxx edit.hxx parsecdxml_variables.hxx
	...
	./tools/pullout
	./tools/option ./edit.hxx ./parsecdxml_variables.hxx
test_install:
