...
/*	strcat(ifilename,"(");
	...
	for (int ilv1=0;ilv1<count;ilv1++)
	{
		...
		{
			fprintf(outfile,"<text fill=\"#000000\" stroke=\"none\" transform=\"translate(%f,%f)\" font-size=\"%f\" font-weight=\"bold\"><tspan>%c)</tspan></text>",(float)makeinf_sortiment.sortiment[ilv1].posx,(float)makeinf_sortiment.sortiment[ilv1].posy+30,(float)((makeinf_sortiment.width>1280)?38:24),'a'+ilv1);
		}
		#endif
	}
	svg_tail();
